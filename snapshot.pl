...
sub save{
    while( $flag == 0 ){ 
        #check if a numbered directory exists
        #if it exists then increment num and try again
        #set flag to 1, loop through all files in current directory and create a backup in $dirname
        #print message
